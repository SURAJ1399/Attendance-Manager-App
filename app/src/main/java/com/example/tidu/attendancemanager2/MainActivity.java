...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CalligraphyConfig.initDefault(new CalligraphyConfig.Builder().setDefaultFontPath("fonts/antqua.ttf").setFontAttrId(R.attr.fontPath).build());
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if(menuItem.getTitle().equals("Delete All")) {
                        ...
                        else if(menuItem.getTitle().equals("Suggest Features")){
                            String email="akash@gmail.com";

                            Intent intent=new Intent(Intent.ACTION_SENDTO);
                            intent.setData(Uri.parse("mailto:"+email));
                            intent.putExtra(Intent.EXTRA_SUBJECT,"Suggesting Features For Attendance Manager");
                            if(intent.resolveActivity(getPackageManager())!=null){
                                startActivity(intent);
                        ...
                        else if (menuItem.getTitle().equals("Update Goal")){
                            AlertDialog.Builder builder2 = new AlertDialog.Builder(MainActivity.this);

                            LayoutInflater inflater2 = MainActivity.this.getLayoutInflater();
                            View view2 = inflater2.inflate(R.layout.dialog_minatd,null);

                            final EditText minat = (EditText)view2.findViewById(R.id.minAdd);

                            Button Update_Btn =  (Button)view2.findViewById(R.id.AddBtn);
                            Button cancel_Btnd = (Button)view2.findViewById(R.id.CancelBtna);
                            ...
                            Update_Btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    SharedPreferences.Editor editor = getApplicationContext().getSharedPreferences("xyz", Context.MODE_PRIVATE).edit();
                                    editor.putString("minatt", minat.getText().toString());
                                    editor.apply();
                                    da.setText( minat.getText().toString()+" %");
                                    add_dialog2.dismiss();
